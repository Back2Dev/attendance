...
import { RegExId, createdAt, updatedAt } from '/imports/api/utils/schema-util'
...
export const AssessmentsSchema = new SimpleSchema({
  ...
  totalCost: {
    ...
    custom() {
      ...
      const services = this.siblingField('services.totalServiceCost').value || 0
      const parts = this.siblingField('parts.totalPartsCost').value || 0
      const additional = this.siblingField('additionalFees').value || 0
