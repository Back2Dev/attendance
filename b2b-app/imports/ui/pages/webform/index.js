...
const WebformBox = (props) => {
  ...
  }, [props.match.params.taskId, props.match.params.form])

  if (trackerData.loading) return <div>Loading webform...</div>

  return <WebformPage {...props} {...trackerData} />
}
