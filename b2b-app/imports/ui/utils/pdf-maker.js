 ...
 * @param {object} styles
 * @param {object} watermark - text, color, opacity, bold?
 * @param {object} images - key => data:image/png;base64
 * @param {string} download - file name. e.g: test.pdf
 */
const PdfMaker = ({
  contents = [],
  styles = {},
  ...
  try {
    ...
    alert('There was a problem creating the printable: ' + error.message)
  }
}
