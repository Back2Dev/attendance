...
const update = (form) => meteorCall('update.jobs', 'updating', form)
const insert = (form) => meteorCall('insert.jobs', 'adding', form)
const add = () => push(`/admin/jobs/add`)
const edit = (id) => push(`/admin/jobs/edit/${id}`)
