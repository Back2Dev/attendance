...
function MechanicSelector() {
  const { item, mechanics, updateJobMechanic } = useContext(JobsDetailsContext)
  ...
  return (
    <StyledMechanicSelector>
      ...
      <IconButton className="btn" size="small" onClick={showSelector}>
