...
import { multiAnswers } from '/imports/ui/forms/survey-builder/recoil/atoms'
...
const MultiInner = ({ pid }) => {
  ...
  return (
    <div>
      ...
      />
      <DndDroppable pid={pid} listAtom={multiAnswers(pid)} type={pid}>
        {(provided) => (
          <ul
            style={{ paddingLeft: 0 }}
...
MultiInner.propTypes = {
  /** multi instance part id */
  pid: PropTypes.string.isRequired,
  /** function gets called when any choice gets updated */
  onChange: PropTypes.func,
}

MultiInner.defaultProps = {
  initialList: [''],
}
