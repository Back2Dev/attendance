...
/** A checkbox button with actions to move it up/down and delete. Used by Multi component */
const Item = forwardRef(
  (
    ...
    const ListStyleType = showMobileActions ? DragHandleIcon : CheckBoxOutlineBlankIcon
