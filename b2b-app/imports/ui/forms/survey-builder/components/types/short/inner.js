...
/** Section Choice question */
const ShortInner = ({ pid }) => {
  const [shortAnswer, setShortAnswer] = useAnswerShort(pid)
  const [question, setQuestion] = useShortQuestion(pid)
  // const theme = useTheme()
  const selectedPart = useSelectedPartValue()
  const { isMobile } = useBuilder()
  console.log(shortAnswer, question)
  ...
  return (
    <div>
      ...
      <Item
        // onRemove={() => remove(i)}
        onTextChange={(name) => setShortAnswer(name)}
        text={shortAnswer}
