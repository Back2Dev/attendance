...
const emailMessage = {
  type: 'EMAIL',
  body: `<div>Thank you for choosing Settle Easy.</div>
  <br/>
...
const smsMessage = {
  type: 'SMS',
  body:
    'You have been assigned `address`. Please call `CUS` to introduce yourself within the next 2 hours and prepare and upload the Contract Review if required.  Cheers, Settle Easy  This is an automated SMS, please do not reply.',
}
...
describe('messages functions', () => {
  ...
  it('merges data into an SMS', () => {
    ...
    expect(result).to.be.equal(
      'You have been assigned 33 Buy Street, Melbourne VIC 3051, Australia. Please call John Smith, Susan Green to introduce yourself within the next 2 hours and prepare and upload the Contract Review if required.  Cheers, Settle Easy  This is an automated SMS, please do not reply.'
    )
  })
  it('merges data into an email', () => {
    ...
    expect(result).to.be.equal(`<div>Thank you for choosing Settle Easy.</div>
  <br/>
